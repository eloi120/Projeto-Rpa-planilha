...
# 1 - Entrar na planilha e extrarir o cpf do cliente
...
for linha in pagina_clientes.iter_rows(min_row = 2, values_only=True):
    ...
    # 2- Entrar no site https://consultacpf-devaprender.netlify.app/ e uso o cpf da planilha para pesquisar o status do pagamento daquele cliente
    ...
    # 4 - Se estiver "em dia", pegar a data do pagamento e o método de pagamento
        ...
        pagina_fechamento.append([nome,valor, cpf, vencimento, 'pendente','não há data pagamento','não há cartão'])
        planilha_fechamento.save('planilha fechamento.xlsx')
